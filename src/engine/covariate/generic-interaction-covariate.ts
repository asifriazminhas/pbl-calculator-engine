...
export type GenericInteractionCovariate<T> = GenericBaseInteractionCovariate<T> | GenericCategoricalInteractionCovariate<T> | GenericContinuousInteractionCovariate<T>;