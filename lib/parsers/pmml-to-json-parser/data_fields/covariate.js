...
function parseCovariates(pmml) {
    ...
    return pmml.pmmlXml.PMML
        .GeneralRegressionModel.CovariateList.Predictor.map(predictor => {
        ...
        return parseCovariateFromPredictor(predictor, dataFieldForCurrentPredictor, parameterForCurrentPredictor, pCellForCurrentParamater, pmml.pmmlXml.PMML.MiningSchema.MiningField
