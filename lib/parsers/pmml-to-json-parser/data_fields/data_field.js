...
var invalid_value_treatment_1 = require("../../pmml/mining-schema/invalid-value-treatment");
...
function parseIsRequired(miningField) {
  return miningField ? miningField.$.invalidValueTreatment === invalid_value_treatment_1.InvalidValueTreatment.ReturnInvalid ? true : false : false;
}
