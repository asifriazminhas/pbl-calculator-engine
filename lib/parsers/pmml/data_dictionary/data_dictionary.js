...
function mergeDataDictionary(dataDictionaryOne, dataDictionaryTwo) {
    const mergedDataFields = data_field_1.mergeDataFields(dataDictionaryOne
        ? undefined_1.returnEmptyArrayIfUndefined(dataDictionaryOne.DataField)
        : [], dataDictionaryTwo
        ? undefined_1.returnEmptyArrayIfUndefined(dataDictionaryTwo.DataField)
        : []);
    return {
