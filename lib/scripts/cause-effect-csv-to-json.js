...
var json_model_1 = require("../parsers/json/json-model"); // tslint:disable-next-line
...
function checkGeneratedCauseEffectJson(causeEffectJson, model, modelName) {
  Object.keys(causeEffectJson).forEach(function (genderKey) {
    var algorithmJsonForCurrentGender = json_model_1.getAlgorithmJsonForPredicateData(model, [{
      name: 'sex',
