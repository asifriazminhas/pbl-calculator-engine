...
function buildFromAssetsFolder(assetsFolderPath) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return {
            ...
            addLifeTable: add_life_table_1.curryAddLifeTable(cox, coxJson),
            toJson: to_json_1.curryToJsonFunction(coxJson)
        };
    });
}
exports.buildFromAssetsFolder = buildFromAssetsFolder;
