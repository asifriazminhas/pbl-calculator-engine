...
export declare type GenericDataField = GenericDataFieldWithoutOpType | GenericCategoricalDataField | GenericContinuousDataField;
...
export declare type GenericDerivedField<T> = GenericDerivedFieldWithoutOpType<T> | GenericCategoricalDerivedField<T> | GenericContinuousDerivedField<T>;
...
export declare type GenericCustomFunctions<T> = GenericRcsCustomFunction<T>;
...
export declare type GenericNonInteractionCovariate<T> = GenericNonInteractionCovariateWithoutOpType<T> | GenericCategoricalNonInteractionCovariate<T> | GenericContinuousNonInteractionCovariate<T>;
...
export declare type GenericInteractionCovariate<T> = GenericInteractionCovariateWithoutOpType<T> | GenericCategoricalInteractionCovariate<T> | GenericContinuousInteractionCovariate<T>;
export declare type GenericCovariate<T> = GenericInteractionCovariate<T> | GenericNonInteractionCovariate<T>;
