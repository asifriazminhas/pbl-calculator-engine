...
var UnAbridgedLifeExpectancy = /*#__PURE__*/function (_LifeExpectancy) {
  ...
  _createClass(UnAbridgedLifeExpectancy, [{
    ...
    value: function getCompleteUnAbridgedLifeTable(data) {
      ...
      var unAbridgedLifeTable = this.genderedUnAbridgedLifeTable[(0, _data2.findDatumWithName)(SexDatumName, data).coefficent]; // The partial life table we will

      var refLifeTableWithQxAndNx = unAbridgedLifeTable.map(function (lifeTableRow) {
        return Object.assign({}, lifeTableRow, {
          qx: _this3.getQx(lifeTableDataWithoutAge.concat({
            name: AgeDatumName,
      ...
      var ageMaxAllowableValue = algorithm.findDataField(AgeDatumName).intervals[0].higherMargin.margin; // Get the index of the life table row after which we need to
