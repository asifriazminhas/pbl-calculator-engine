...
var UnAbridgedLifeExpectancy = /*#__PURE__*/function (_LifeExpectancy) {
  ...
  _createClass(UnAbridgedLifeExpectancy, [{
    ...
    value: function getSurvivalToAge(data, toAge) {
      ...
      var ageDatum = (0, _data2.findDatumWithName)(AgeDatumName, data);
      var completeLifeTable = this.getCompleteUnAbridgedLifeTable(data);
      var lifeTableRowForCurrentAge = completeLifeTable.find(function (_ref) {
        var age = _ref.age;
        return age === ageDatum.coefficent;
      });

      if (!lifeTableRowForCurrentAge) {
        throw new Error("No life table row found for individual's age ".concat(ageDatum.coefficent));
      }

      var lifeTableRowForToAge = completeLifeTable.find(function (_ref2) {
        var age = _ref2.age;
        return age === toAge;
      });

      if (!lifeTableRowForToAge) {
        throw new Error("No life table row found for toAge ".concat(toAge));
      }
...
exports.UnAbridgedLifeExpectancy = UnAbridgedLifeExpectancy = (0, _tslib.__decorate)([_autobind2.default], UnAbridgedLifeExpectancy);
