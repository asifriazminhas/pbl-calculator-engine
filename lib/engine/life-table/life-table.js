...
function getCompleteLifeTableForDataUsingAlgorithm(refLifeTable, data, cox) {
  ...
  var dataWithoutAgeFields = data_2.filterDataForFields(data, allAgeFields);
  ...
  var lifeTableDataWithoutAge = data_2.filterDataForFields(cox.getCovariatesWithoutGroup('AGE')
