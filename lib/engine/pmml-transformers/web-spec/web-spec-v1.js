...
exports.ActiveUsageType = exports.SupplementaryUsageType = void 0;
...
var SupplementaryUsageType = 'supplementary';
exports.SupplementaryUsageType = SupplementaryUsageType;
var ActiveUsageType = 'active';
/**
...
exports.ActiveUsageType = ActiveUsageType;
...
function transformPhiatDictionaryToPmml(algorithmName, phiatCsvString, webSpecificationsCategories, algorithmInfo, gender, addMeans, addBetas) {
  ...
  Object.keys(dataFields).forEach(function (dataField) {
    var dataFieldEle = dataDictionary.ele('DataField', {
      ...
      dataType: 'double',
      displayName: (0, _undefined.returnEmptyStringIfUndefined)(dataFields[dataField].displayName)
    });
    ...
    dataFieldEle.ele('Extension', {
      name: 'units',
      value: (0, _undefined.returnEmptyStringIfUndefined)(dataFields[dataField].Units)
    });
    dataFieldEle.ele('Extension', {
      name: 'description',
      value: (0, _undefined.returnEmptyStringIfUndefined)(dataFields[dataField].displayValue)
    ...
    if (dataFields[dataField].variableType === 'continuous') {
      dataFieldEle.ele('Interval', {
        ...
        leftMargin: (0, _undefined.returnEmptyStringIfUndefined)(dataFields[dataField].UserMin),
        rightMargin: (0, _undefined.returnEmptyStringIfUndefined)(dataFields[dataField].UserMax)
      });
    } else {
