...
function getAlgorithmNamesToTest(excludeAlgorithms) {
  ...
  assets */
  .readdirSync(_constants.TestAlgorithmsFolderPath)
  /* Filter out all files and keep only directories */
  .filter(function (algorithmFolderFileName) {
    return fs.lstatSync(path.join(_constants.TestAlgorithmsFolderPath, algorithmFolderFileName)).isDirectory() && algorithmFolderFileName !== '.git' && algorithmFolderFileName !== 'node_modules' && algorithmFolderFileName !== 'build' && algorithmFolderFileName !== '.vscode';
  })
...
function _getModelObjFromAlgorithmName() {
  _getModelObjFromAlgorithmName = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(algorithmName) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", new _model.Model(require("".concat(_constants.TestAlgorithmsFolderPath, "/").concat(algorithmName, "/model.json"))));
...
function _getModelsToTest() {
  _getModelsToTest = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(modelsToExclude) {
...
function _runIntegrationTest() {
  _runIntegrationTest = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(validationFilesFolderName, validationFileName, testType, modelsToExclude, runTestForDataAndAlgorithm, t) {
    var modelsToTest;
            ...
            modelsToTest.forEach(function (_ref) {
              ...
              t.test("Testing ".concat(testType, " for model ").concat(model.name), function (t) {
                ...
                if (model.algorithms.length === 1) {
                  validationCsvFilePaths.push(getCsvFilePathsInFolder("".concat(_constants.TestAlgorithmsFolderPath, "/").concat(model.name, "/validation-data/").concat(validationFilesFolderName)));
                  modelPredicateDatas.push([]);
                } else {
                  validationCsvFilePaths.push(getCsvFilePathsInFolder("".concat(_constants.TestAlgorithmsFolderPath, "/").concat(model.name, "/validation-data/").concat(validationFilesFolderName, "/male")));
                  modelPredicateDatas.push([{
                    name: 'sex',
                    coefficent: 'male'
                  }]);
                  validationCsvFilePaths.push(getCsvFilePathsInFolder("".concat(_constants.TestAlgorithmsFolderPath, "/").concat(model.name, "/validation-data/").concat(validationFilesFolderName, "/female")));
                  modelPredicateDatas.push([{
                    name: 'sex',
                    coefficent: 'female'
                  }]);
