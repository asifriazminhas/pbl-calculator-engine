...
const binsLookupCsvString = fs.readFileSync(`${constants_1.TestAssetsDirPath}/bins/bins-lookup.csv`, 'utf8');
const binsDataCsvString = fs.readFileSync(`${constants_1.TestAssetsDirPath}/bins/bins-data.csv`, 'utf8');
