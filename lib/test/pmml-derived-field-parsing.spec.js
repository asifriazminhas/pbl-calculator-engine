...
var _pmml = require("../parsers/pmml");

var _derived_field = require("../parsers/pmml-to-json-parser/data_fields/derived_field/derived_field");
...
function _getPmmlForTest() {
  _getPmmlForTest = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_ref) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 5;
            return _pmml.PmmlParser.parsePmmlFromPmmlXmlStrings([pmmlString]);
...
function doAssertions(t, derivedFieldsToTest, fieldColumnPairs, tableName, outputColumn) {
  (0, _chai.expect)(derivedFieldsToTest.length).to.equal(1);
  t.pass("Returned expected number of derived fields");
  (0, _chai.expect)(derivedFieldsToTest[0].derivedFrom.map(function (dataField) {
  ...
  (0, _chai.expect)(derivedFieldsToTest[0].equation).to.equal("derived = getValueFromTable(tables['".concat(tableName, "'], '").concat(outputColumn, "', {").concat(objectToPassIn, "});"));
...
function _testMultipleFieldColumnPair() {
  _testMultipleFieldColumnPair = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(t) {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            pmml = _context4.sent;
            derivedFields = (0, _derived_field.parseDerivedFields)(pmml, []);
...
function _testSingleFieldColumnPair() {
  _testSingleFieldColumnPair = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(t) {
    var derivedFieldName, tableName, outputColumn, fieldColumnPairs, pmml, derivedFields;
...
test.skip("Parsing derived field from PMML", function (t) {
  t.test("Testing single FieldColumnPairs", /*#__PURE__*/function () {
  ...
  t.test("Testing multiple FieldColumnPairs", /*#__PURE__*/function () {
